...
declare const supportedRemixEsbuildConfigKeys: readonly ["appDirectory", "future", "ignoredRouteFiles", "publicPath", "routes", "serverModuleFormat"];
...
export type VitePluginConfig = RemixEsbuildUserConfigJsdocOverrides & Omit<SupportedRemixEsbuildUserConfig, keyof RemixEsbuildUserConfigJsdocOverrides> & {
    /**
...
export declare let setRemixDevLoadContext: (loadContext: Record<string, unknown>) => void;
